...
describe("Staking", function () {
  ...
  describe("stakeEther", function () {
    ...
    it("adds a position to positions", async function () {
      ...
      expect(position.unlockDate).to.equal(block.timestamp + 86400 * 90); //86400 seconds are in a day, block tiemstamp is in seconds
  ...
  describe("modifyLockPeriods", function () {
    describe("owner", function () {
      ...
      it("should modify an existent lock period", async function () {
    ...
    describe("non-owner", function () {
      it("reverts", async function () {
        ...
        ).to.be.revertedWith("Only owner may modifiy staking periods");
      });
    });
  });
